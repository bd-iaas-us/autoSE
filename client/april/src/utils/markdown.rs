...
pub const SYNTAXES: &[u8] = include_bytes!("../../assets/syntaxes.bin");
pub const DARK_THEME: &[u8] = include_bytes!("../../assets/monokai-extended.theme.bin");
pub const LIGHT_THEME: &[u8] = include_bytes!("../../assets/monokai-extended-light.theme.bin");
